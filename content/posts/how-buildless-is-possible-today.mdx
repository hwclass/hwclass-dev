...
![](https://buildless-site-git-add-cover-dev-to.hwclass.now.sh/static/dev.to.png)

_Encouraging warning: This article is not telling how to do something, instead telling how to change the paradigm of the current web status-quo._
