---
title: >-
  AWS-rendered React chocolate chips with Dawson— Part 1: A simple service for
  serving components
description: >-
  For a while, I’ve been searching for the alternative methods for having
  components or page fragments independently from each other…
date: '2017-07-19T17:08:46.924Z'
---

![](https://cdn-images-1.medium.com/max/800/1*Lz1dvaljBRZ_h1vm5MIouQ.png)
